...
import { type FluidLpInput, solveFluidLp } from "../../src/admission/fluid-lp";
 ...
 *     optimality, so the certificate proves correctness of both the admit plan
 *     and the recovered duals without an external LP solver. A random-feasible-x
 *     sampler adds an independent "nothing beats it" lower-bound check.
 */
